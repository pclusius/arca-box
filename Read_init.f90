...
integer :: dmps_rows, dmps_cols,temp_rows, temp_cols,voc_rows, voc_cols

NAMELIST /NML_DMPS/ DMPS_file, dmps_file_check, dmps_rows, dmps_cols
NAMELIST /NML_TEMP/ TEMP_path, TEMP_file, temp_file_check, temp_rows, temp_cols
NAMELIST /NML_VOC / VOC_file, voc_file_check, voc_rows, voc_cols
