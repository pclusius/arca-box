...
BOX_OBJECTS = $(addprefix $(OBJDIR)/, second_precision.o constants.o auxillaries.o Read_init.o Input.o output.o)
...
$(OBJDIR)/Superbox.o: Supermodel_main.f90 $(BOX_OBJECTS) $(ACDC_OBJECTS) $(ACDC_D_OBJECTS)
	 $(F90) $(BOX_OPTS) -c $< -o $@
