...
MODULE second_constants

  USE second_Precision, ONLY: dp
  USE second_Parameters ! ind_*
  USE second_Global, ONLY: C, TEMP,J,M, N2, O2, RO2, H2O
  IMPLICIT NONE

  INTEGER, PARAMETER :: J_O3_O1D          =  1 ! IN NEW MCM J= 1 O3        -> O(1D) + O2
  INTEGER, PARAMETER :: J_O3_O3P          =  2 ! IN NEW MCM J= 2 O3        -> O(3P) + O2
  INTEGER, PARAMETER :: J_H2O2            =  3 ! IN NEW MCM J= 3 H2O2      -> OH + OH
  INTEGER, PARAMETER :: J_NO2             =  4 ! IN NEW MCM J= 4 NO2       -> NO + O(3P)
  INTEGER, PARAMETER :: J_NO3_NO          =  5 ! IN NEW MCM J= 5 NO3       -> NO + O2
  INTEGER, PARAMETER :: J_NO3_NO2         =  6 ! IN NEW MCM J= 6 NO3       -> NO2 + O(3P)
  INTEGER, PARAMETER :: J_HONO            =  7 ! IN NEW MCM J= 7 HONO      -> NO + OH
  INTEGER, PARAMETER :: J_HNO3            =  8 ! IN NEW MCM J= 8 HNO3      -> NO2 + OH
  INTEGER, PARAMETER :: J_HCHO_H          = 11 ! IN NEW MCM J= 9 HCHO      -> H + HCO
  INTEGER, PARAMETER :: J_HCHO_H2         = 12 ! IN NEW MCM J=10 HCHO      -> H2 + CO
  INTEGER, PARAMETER :: J_CH3CHO          = 13 ! IN NEW MCM J=11 CH3CHO    -> CH3 + HCO
  INTEGER, PARAMETER :: J_C2H5CHO         = 14 ! IN NEW MCM J=12 C2H5CHO   -> C2H5 + HCO
  INTEGER, PARAMETER :: J_C3H7CHO_HCO     = 15 ! IN NEW MCM J=13 C3H7CHO   -> n-C3H7 + HCO
  INTEGER, PARAMETER :: J_C3H7CHO_C2H4    = 16 ! IN NEW MCM J=14 C3H7CHO   -> C2H4 + CH3CHO
  INTEGER, PARAMETER :: J_IPRCHO          = 17 ! IN NEW MCM J=15 IPRCHO    -> n-C4H9 + HCO
  INTEGER, PARAMETER :: J_MACR_HCO        = 18 ! IN NEW MCM J=16 MACR      -> CH2=CCH3 + HCO
  INTEGER, PARAMETER :: J_MACR_H          = 19 ! IN NEW MCM J=17 MACR      -> CH2=C(CH3)CO + H
  INTEGER, PARAMETER :: J_C5HPALD1        = 20 ! IN NEW MCM J=18 C5HPALD1  -> CH3C(CHO)=CHCH2O + OH
  INTEGER, PARAMETER :: J_CH3COCH3        = 21 ! IN NEW MCM J=19 CH3COCH3  -> CH3CO + CH3
  INTEGER, PARAMETER :: J_MEK             = 22 ! IN NEW MCM J=20 MEK       -> CH3CO + C2H5
  INTEGER, PARAMETER :: J_MVK_CO          = 23 ! IN NEW MCM J=21 MVK       -> CH3CH=CH2 + CO
  INTEGER, PARAMETER :: J_MVK_C2H3        = 24 ! IN NEW MCM J=22 MVK       -> CH3CO + CH2=CH
  INTEGER, PARAMETER :: J_GLYOX_H2        = 31 ! IN NEW MCM J=23 GLYOX     -> CO + CO + H2
  INTEGER, PARAMETER :: J_GLYOX_HCHO      = 32 ! IN NEW MCM J=24 GLYOX     -> HCHO + CO
  INTEGER, PARAMETER :: J_GLYOX_HCO       = 33 ! IN NEW MCM J=25 GLYOX     -> HCO + HCO
  INTEGER, PARAMETER :: J_MGLYOX          = 34 ! IN NEW MCM J=26 MGLYOX    -> CH3CO + HCO
  INTEGER, PARAMETER :: J_BIACET          = 35 ! IN NEW MCM J=27 BIACET    -> CH3CO + CH3CO
  INTEGER, PARAMETER :: J_CH3OOH          = 41 ! IN NEW MCM J=28 CH3OOH    -> CH3O + OH
  INTEGER, PARAMETER :: J_CH3NO3          = 51 ! IN NEW MCM J=29 CH3NO3    -> CH3O + NO2
  INTEGER, PARAMETER :: J_C2H5NO3         = 52 ! IN NEW MCM J=30 C2H5NO3   -> C2H5O + NO2
  INTEGER, PARAMETER :: J_NC3H7NO3        = 53 ! IN NEW MCM J=31 NC3H7NO3  -> n-C3H7O + NO2
  INTEGER, PARAMETER :: J_IC3H7NO3        = 54 ! IN NEW MCM J=32 IC3H7NO3  -> CH3C(O.)CH3 + NO2
  INTEGER, PARAMETER :: J_TC4H9NO3        = 55 ! IN NEW MCM J=33 TC4H9NO3  -> t-C4H9O + NO2
  INTEGER, PARAMETER :: J_NOA             = 56 ! IN NEW MCM J=34 NOA       -> CH3C(O)CH2(O.) + NO2 or CH3CO + HCHO + NO2
