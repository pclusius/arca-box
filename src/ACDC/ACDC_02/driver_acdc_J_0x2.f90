module driver_acdc_J_0x2
use solution_settings_new
use acdc_system_0x2, only : small_set_mode, n_charges		! simulation mode and numbers of charging states
use acdc_system_0x2, only : n_variables, variable_temp		! information on parameters that vary based on input
use acdc_simulation_setup_0x2, only : solve_ss, j_flux, use_solver	! logicals for the solution approaches
use acdc_simulation_setup_0x2, only : sources_and_constants ! for determining fitted concentrations
use acdc_equations_0x2, feval=>feval_0x2, jeval=>jeval_0x2, formation=>formation_0x2

implicit none

contains

subroutine acdc_driver_0x2(neqn,nclust,nout_all,c,cs_ref,temperature,ipr,t_max,t_tot,t_iter,ipar,ok,j_out)
...
end subroutine acdc_driver_0x2
