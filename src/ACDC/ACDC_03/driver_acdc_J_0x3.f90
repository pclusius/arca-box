module driver_acdc_J_0x3
use solution_settings_new
use acdc_system_0x3, only : small_set_mode, n_charges		! simulation mode and numbers of charging states
use acdc_system_0x3, only : n_variables, variable_temp		! information on parameters that vary based on input
use acdc_simulation_setup_0x3, only : solve_ss, j_flux, use_solver	! logicals for the solution approaches
use acdc_simulation_setup_0x3, only : sources_and_constants ! for determining fitted concentrations
use acdc_equations_0x3, feval=>feval_0x3, jeval=>jeval_0x3, formation=>formation_0x3

implicit none

contains

subroutine acdc_driver_0x3(neqn,nclust,nout_all,c,cs_ref,temperature,ipr,t_max,t_tot,t_iter,ipar,ok,j_out)
...
end subroutine acdc_driver_0x3
