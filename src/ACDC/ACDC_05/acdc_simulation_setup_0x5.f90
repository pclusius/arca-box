module acdc_simulation_setup_0x5

use acdc_system_0x5

implicit none

logical :: solve_ss = .false. 		! solve the steady state or run only for a given time
logical, parameter :: j_flux = .true.			! J calculated as a flux or as particles per time step; note that the former
...
end module acdc_simulation_setup_0x5
