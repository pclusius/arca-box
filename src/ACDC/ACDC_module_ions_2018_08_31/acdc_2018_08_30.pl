...
my($ncols,$this_clus,$icol,$i,$j,$k,$l,$n,$ii,$jj,$kk,$ll,$jm,$km,$lm,$jc,$kc,$lc,$combined);
...
if(!$lloop){
	...
	if($lfortran){
		...
		print SYST "\ninteger, parameter :: n_neutral_monomers = $jm\t\t\t! number of neutral monomers\n";
		print SYST "integer, parameter :: n_negative_monomers = $km\t\t\t! number of negative monomers\n";
		print SYST "integer, parameter :: n_positive_monomers = $lm\t\t\t! number of positive monomers\n";
		...
		if($lines{'0m'} ne ''){
			$lines{'m_inp'} .= "neutral_monomers, ";
			$lines{'m_size'} .= "neutral_monomers($jm), ";
			$lines{'m_def'} .= "\tneutral_monomers = (/$lines{'0m'}/)\n";
		}
		if($lines{'0c'} ne ''){
		...
		if($k>0){
			...
			if($lines{'nm'} ne ''){
				$lines{'m_inp'} .= "negative_monomers, ";
				$lines{'m_size'} .= "negative_monomers($km), ";
				$lines{'m_def'} .= "\tnegative_monomers = (/$lines{'nm'}/)\n";
			}
			if($lines{'nc'} ne ''){
		...
		if($l>0){
			...
			if($lines{'pm'} ne ''){
				$lines{'m_inp'} .= "positive_monomers, ";
				$lines{'m_size'} .= "positive_monomers($lm), ";
				$lines{'m_def'} .= "\tpositive_monomers = (/$lines{'pm'}/)\n";
			}
			if($lines{'pc'} ne ''){
		...
		$lines{'m_inp'} =~ s/, $//;
		if($lines{'m_inp'} ne ''){
			print SYST "subroutine monomer_arrays$append_to_subroutine_names($lines{'m_inp'})\n\timplicit none\n";
			$lines{'m_size'} =~ s/, $//;
			print SYST "\tinteger :: $lines{'m_size'}\n\n";
			print SYST $lines{'m_def'};
			print SYST "\nend subroutine monomer_arrays$append_to_subroutine_names\n\n";
		}
		$lines{'c_inp'} =~ s/, $//;
